...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { birthday: @child.birthday, first_name: @child.first_name, last_name: @child.last_name }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { birthday: @child.birthday, first_name: @child.first_name, last_name: @child.last_name }
    assert_redirected_to child_path(assigns(:child))
  end
